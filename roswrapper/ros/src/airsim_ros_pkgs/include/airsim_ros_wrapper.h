...
private:
    ...
    void append_static_camera_tf(VehicleROS *vehicle_ros,
                                 ...
                                 const CameraSetting &camera_setting);
    void
    append_static_lidar_tf(VehicleROS *vehicle_ros,
    ...
    sensor_msgs::Range get_range_from_airsim(
        const msr::airlib::DistanceSensorData &dist_data) const;
    ...
    ros::Time
    airsim_timestamp_to_ros(const msr::airlib::TTimePoint &stamp) const;
